...
# distance = 3;
# tranport_type = None;
# if distance <3 : tranport_type = "Walk";
# elif distance > 3 and distance < 15 : tranport_type = "Bike";
# elif distance > 15: tranport_type = "Car";
